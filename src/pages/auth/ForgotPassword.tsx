...
//                   Vui lòng kiểm tra hộp thư đến email của bạn và làm theo hướng
//                   dẫn để đặt lại mật khẩu. Liên kết sẽ có hiệu lực trong vòng 24
//                   giờ.
//                 </Typography>
//                 <Button
//                   fullWidth
...
//               <>
//                 <Typography variant="body2" sx={{ mb: 3, textAlign: "center" }}>
//                   Nhập địa chỉ email bạn đã sử dụng để đăng ký tài khoản. Chúng
//                   tôi sẽ gửi cho bạn một liên kết để đặt lại mật khẩu.
//                 </Typography>
