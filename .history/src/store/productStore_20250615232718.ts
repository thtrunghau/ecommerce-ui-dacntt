...
import type { ProductResDto, CategoryResDto, UUID, PaginationParams } from "../types/api";
...
const useProductStore = create<ProductState>()(
  persist(
    (set, get) => ({
      ...
      // Actions      fetchProducts: async (_params?: PaginationParams) => {
        set({ isLoading: true, error: null });
        
        try {
          // In a real app, we would call an API here
          // const response = await productApi.getList(_params);
