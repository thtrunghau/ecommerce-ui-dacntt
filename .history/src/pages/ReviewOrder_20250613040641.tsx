        ...
        <div className="lg:col-span-1">
          <div className="rounded-lg bg-white p-6 shadow">
            ...
            <div className="mt-6 space-y-3">
              <Link
                to="/payment"
                className="block w-full rounded-full bg-black px-4 py-3 text-center text-white transition-colors hover:bg-gray-800 hover:shadow-lg"
              >
                Tiến hành thanh toán
              </Link>
              <Link
                to="/cart"
                className="block w-full rounded-full border border-gray-300 px-4 py-3 text-center text-gray-700 transition-colors hover:bg-gray-50"
              >
                Quay lại giỏ hàng
              </Link>
            </div>
