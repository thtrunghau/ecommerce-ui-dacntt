      ...
      <div className="flex flex-grow flex-col p-4">
        ...
        <div className="mt-auto space-y-2">
          <button
            ...
            className="w-full rounded-full bg-black border border-black px-3 py-1.5 text-sm font-medium text-white transition-all duration-200 hover:bg-white hover:text-black hover:shadow-md active:scale-95"
          >
            Thêm vào giỏ hàng
          </button>
          <button
