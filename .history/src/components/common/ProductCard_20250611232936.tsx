...
const ProductCard: React.FC<ProductCardProps> = ({
  ...
  return (
    <div
      className={`rounded-lg bg-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg ${className}`}
    >
      {/* Product Image */}
      ...
      <div className="p-4">
        {/* Product Name */}
        <h4 className="mb-2 line-clamp-2 cursor-pointer font-semibold text-gray-900 transition-colors hover:text-blue-600">
          {product.productName}
        </h4>
        ...
        <div className="mb-4 space-y-2">
          <button
            ...
            className="w-full rounded-lg bg-black px-4 py-2.5 font-medium text-white transition-all duration-200 hover:bg-gray-800 hover:shadow-md active:scale-95"
          >
            Thêm vào giỏ hàng
          </button>
          <button
            onClick={handleLearnMore}
            className="w-full rounded-lg border border-black px-4 py-2.5 font-medium text-black transition-all duration-200 hover:bg-gray-50 hover:shadow-md active:scale-95"
          >
            Tìm hiểu thêm
          </button>
        </div>
