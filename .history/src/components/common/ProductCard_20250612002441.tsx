  ...
  return (
    ...
    >
      ...
      <div className="flex flex-grow flex-col p-4">
        ...
        </div>        {/* Action Buttons - Push to bottom */}
        <div className="mt-auto space-y-2">
          <button
            onClick={handleAddToCart}
            className="w-full rounded-full bg-black border border-black px-4 py-2.5 font-medium text-white transition-all duration-200 hover:bg-white hover:text-black hover:shadow-md active:scale-95"
          >
            Thêm vào giỏ hàng
          </button>
          <button
            onClick={handleLearnMore}
            className="w-full rounded-full border border-black bg-white px-4 py-2.5 font-medium text-black transition-all duration-200 hover:bg-black hover:text-white hover:shadow-md active:scale-95"
          >
            Tìm hiểu thêm
          </button>
        </div>
