        ...
        <div className="relative flex items-center justify-between">
          ...
          <nav className="mx-4 mt-[14px] hidden lg:flex">
            {navItems.map((item) => {
              ...
              const hasDropdown = categoryId || isPromotion;              return (
                <div
                  key={item.id}
                ...
                >
                  ...
                  {/* Invisible bridge for smooth hover experience */}
                  {hasDropdown && activeDropdown === (isPromotion ? "promotion" : categoryId) && (
