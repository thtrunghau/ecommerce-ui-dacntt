...
const Header: React.FC = () => {
  ...
  // Navigation function for category filtering
  const navigateToProducts = (categoryId?: string, isPromotion?: boolean) => {
    console.group("🚀 NAVIGATION TO PRODUCTS");

    if (isPromotion) {
      console.log("Navigation Type: Promotion Products");
      console.log("Target URL: /products?promotion=true");
      console.log("Expected ProductsSection behavior: Filter products with active promotions");
      navigate("/products?promotion=true");
    } else if (categoryId) {
      console.log("Navigation Type: Category Filter");
      console.log("Category ID:", categoryId);
      console.log("Target URL:", `/products?category=${categoryId}`);
      console.log("Expected ProductsSection behavior: Filter products by category");
      navigate(`/products?category=${categoryId}`);
    } else {
      console.log("Navigation Type: All Products");
      console.log("Target URL: /products");
      console.log("Expected ProductsSection behavior: Show all products");
      navigate("/products");
    }
  ...
  // Handle dropdown data preparation
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 py-2">
                ...
                >
                  {" "}                  <button
                    onClick={() => {
                      ...
                      const isPromotion = item.path.includes("promotion=true");
                      navigateToProducts(categoryId || undefined, isPromotion);
                    }}
        ...
        </div>{" "}        {/* Dropdown Menu - Always centered */}
        {activeDropdown &&
          (() => {
          ...
          <div className="p-4">
            ...
            >
              ...
              <button
                ...
                className="flex items-center justify-between border-b py-3 w-full text-left"
              >
