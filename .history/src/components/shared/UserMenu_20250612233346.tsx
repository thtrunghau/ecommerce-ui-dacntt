...
const UserMenu: React.FC<UserMenuProps> = ({ anchorEl, open, onClose }) => {
  ...
  return (
    <>
      ...
      <div
        ref={menuRef}
        className={`absolute z-50 min-w-[240px] rounded-xl bg-white shadow-2xl border border-gray-100 focus:outline-none transform transition-all duration-200 ease-out ${
          open 
