...
import { getAllApplicablePromotions, getProductPriceInfo, formattedPrice } from "../../utils/helpers";
      ...
      <div className="px-8 py-6">
        ...
        <div className="grid grid-cols-4 gap-6">
          {" "}          {category.products.map((product: ProductResDto) => {
            ...
            const priceInfo = hasPromotion ? getProductPriceInfo(product.id, product.price) : null;
            ...
            return (
              ...
              >
                ...
                <div className="text-center">
                  <span className="text-[15px] font-medium text-gray-900 line-clamp-2">
                    {product.productName}
                  </span>
                  {/* Price Information */}
                  <div className="mt-1">
