    ...
    <section className="bg-gradient-to-br from-gray-50 via-white to-gray-50 py-16">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col space-y-8">
          ...
          <div className="flex flex-col gap-8 lg:flex-row">            {/* Left Column - Categories */}
            ...
            </div>{" "}            {/* Right Column - Products Grid */}
                  ...
                  {hasMoreProducts() && (
                    <div className="mt-12 text-center">
                      <button
                        ...
                        className="group relative overflow-hidden rounded-full bg-gradient-to-r from-blue-600 to-blue-700 px-8 py-4 font-semibold text-white shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-105 active:scale-95"
                      >
