...
export type { ProductResDto, CategoryResDto, PromotionResDto, CartResDto, CartItemResDto, AddressResDto, OrderResDto } from './api';

// Keep existing types for frontend-specific needs
