// Re-export API types for new implementation
export * from './api';

// Re-export order types with explicit naming to avoid conflicts  
export type { OrderDto, AddressDto, OrderItemDto as LegacyOrderItemDto } from './order';

// Keep original frontend types for backward compatibility
...
// API Pagination Types (alias for backward compatibility)
